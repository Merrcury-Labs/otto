...
job_research = GenerationJobViewSet.as_view({'get': 'research'})
job_usage = GenerationJobViewSet.as_view({'get': 'usage'})
job_review_blueprint = GenerationJobViewSet.as_view({'post': 'review_blueprint'})
job_review_final = GenerationJobViewSet.as_view({'post': 'review_final'})
...
urlpatterns = [
    ...
    path('generation-jobs/<uuid:pk>/research/', job_research, name='generation-job-research'),
    path('generation-jobs/<uuid:pk>/usage/', job_usage, name='generation-job-usage'),
    path('generation-jobs/<uuid:pk>/review-blueprint/', job_review_blueprint, name='generation-job-review-blueprint'),
    path('generation-jobs/<uuid:pk>/review-final/', job_review_final, name='generation-job-review-final'),
